...
//    }
    ...
    public FirebaseFindRouteListAdapter(FirebaseRecyclerOptions options){
        super(options);
    }

    @Override
    public FirebaseFindRouteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.route_list_item_drag, parent);
        return new FirebaseFindRouteViewHolder(view);

    }

    @Override
    public void onBindViewHolder(final FirebaseFindRouteViewHolder holder, int position, Route model) {
        ...
        holder.mRouteImageView.setOnTouchListener(new View.OnTouchListener() {
